...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('Tambah Data Kunjungan TBC') }}</h1>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('kunjungan_tbc.store') }}" method="post" id="modal-save-form">
                @csrf
                ...
                <div class="card" style="margin-top: 2%">
                    ...
                    <div class="card" style="margin: 2%">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('batuk_skrining') is-invalid @enderror"
                                        ...
                                        <option value="Ya" {{ old('batuk_skrining') == 'Ya' ? 'selected' : '' }}>
                                            Ya</option>
                                        <option value="Tidak" {{ old('batuk_skrining') == 'Tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('demam_skrining') is-invalid @enderror"
                                        ...
                                        <option value="Ya" {{ old('demam_skrining') == 'Ya' ? 'selected' : '' }}>
                                            Ya</option>
                                        <option value="Tidak" {{ old('demam_skrining') == 'Tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                        ...
                        <div class="row" style="margin: 1%">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="bb_skrining">BB Tidak Naik Atau Turun Dalam 2 Bulan Berturut-Turut</label>
                                    <select class="form-control @error('bb_skrining') is-invalid @enderror"
                                        ...
                                        <option value="Ya" {{ old('bb_skrining') == 'Ya' ? 'selected' : '' }}>
                                            Ya</option>
                                        <option value="Tidak" {{ old('bb_skrining') == 'Tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                                    @error('bb_skrining')
                                        <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('kontak_erat_keluarga') is-invalid @enderror"
                                        ...
                                        <option value="Ya"
                                            {{ old('kontak_erat_keluarga') == 'Ya' ? 'selected' : '' }}>
                                            Ya</option>
                                        <option value="Tidak"
                                            {{ old('kontak_erat_keluarga') == 'Tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('kontak_erat_tetangga') is-invalid @enderror"
                                        ...
                                        <option value="Ya"
                                            {{ old('kontak_erat_tetangga') == 'Ya' ? 'selected' : '' }}>
                                            Ya</option>
                                        <option value="Tidak"
                                            {{ old('kontak_erat_tetangga') == 'Tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('kontak_erat_art') is-invalid @enderror"
                                        ...
                                        <option value="Ya" {{ old('kontak_erat_art') == 'Ya' ? 'selected' : '' }}>
                                            Ya</option>
                                        <option value="Tidak" {{ old('kontak_erat_art') == 'Tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tmp_diaknosa') is-invalid @enderror"
                                        ...
                                        <option value="Rumah Sakit"
                                            {{ old('tmp_diaknosa') == 'Rumah Sakit' ? 'selected' : '' }}>
                                            Rumah Sakit</option>
                                        <option value="Puskesmas"
                                            {{ old('tmp_diaknosa') == 'Puskesmas' ? 'selected' : '' }}>
                                            Puskesmas</option>
                                        <option value="Rumah" {{ old('tmp_diaknosa') == 'Rumah' ? 'selected' : '' }}>
                                            Rumah</option>
                                    </select>
                                    @error('tmp_diaknosa')
                                        <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('tgl_periksa_terakhir') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tmp_periksa_terakhir') is-invalid @enderror"
                                        ...
                                        <option value="" disabled selected>Pilih Tempat</option>
                                        <option value="Rumah Sakit"
                                            {{ old('tmp_periksa_terakhir') == 'Rumah Sakit' ? 'selected' : '' }}>
                                            Rumah Sakit</option>
                                        <option value="Puskesmas"
                                            {{ old('tmp_periksa_terakhir') == 'Puskesmas' ? 'selected' : '' }}>
                                            Puskesmas</option>
                                        <option value="Rumah"
                                            {{ old('tmp_periksa_terakhir') == 'Rumah' ? 'selected' : '' }}>
                                            Rumah</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('obat_tbc') is-invalid @enderror" name="obat_tbc"
                                        ...
                                        <option value="Ada" {{ old('obat_tbc') == 'Ada' ? 'selected' : '' }}>
                                            Ada</option>
                                        <option value="Tidak" {{ old('obat_tbc') == 'Tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                                    @error('obat_tbc')
                                        <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('minum_obat_tbc') is-invalid @enderror"
                                        ...
                                        <option value="Ya" {{ old('minum_obat_tbc') == 'Ya' ? 'selected' : '' }}>
                                            Ya</option>
                                        <option value="Tidak" {{ old('minum_obat_tbc') == 'Tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_pmo') is-invalid @enderror"
                                    name="nama_pmo" id="nama_pmo" autocomplete="off" value="{{ old('nama_pmo') }}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('edukasi') is-invalid @enderror"
                                    name="edukasi" id="edukasi" autocomplete="off" value="{{ old('edukasi') }}"
                ...
                <div class="card" style="margin-top: 2%">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('periksa_postu_fasyankes') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tgl_lapor') is-invalid @enderror"
                                    name="tgl_lapor" id="tgl_lapor" autocomplete="off" value="{{ old('tgl_lapor') }}">
                                @error('tgl_lapor')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <a href="{{ route('kunjungan_tbc.index') }}" class="btn btn-default">Back to list</a>
                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var fields = {
                ...
                'kontak_erat_keluarga': document.getElementById('kontak_erat_keluarga'),
                'kontak_erat_tetangga': document.getElementById('kontak_erat_tetangga'),
                'kontak_erat_art': document.getElementById('kontak_erat_art'),
