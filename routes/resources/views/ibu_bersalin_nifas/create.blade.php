...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('Tambah Data Ibu Bersalin Nifas') }}</h1>
    ...
    <div class="card">
        <div class="progress">
            <div class="progress-bar" role="progressbar" style="width: 48%;" aria-valuenow="25" aria-valuemin="0"
                aria-valuemax="100">48%</div>
        </div>
        <div class="card-body" style="text-align: center;">
            {{-- <form action="{{ route('ibu_bersalin_nifas.store') }}" method="post" id="modal-save-form"> --}}
            <form action="{{ route('ibu_bersalin_nifas.storeibuber') }}" method="post" id="modal-save-form">
                @csrf
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('nik') is-invalid @enderror" name="nik"
                                    id="nik" placeholder="NIK" autocomplete="off" value="{{ old('nik') }}"
                                    required>
                                @error('nik')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tgl_persalinan') is-invalid @enderror"
                                    ...
                                    autocomplete="off" value="{{ old('tgl_persalinan') }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control @error('pukul_persalinan') is-invalid @enderror"
                                    name="pukul_persalinan" id="pukul_persalinan" value="{{ old('pukul_persalinan') }}"
                                    required step="300">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    ...
                                    value="{{ old('usia_kehamilan_persalinan') }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('penolong_persalinan') is-invalid @enderror"
                                    ...
                                    <option value="Bidan" {{ old('penolong_persalinan') === 'Bidan' ? 'selected' : '' }}>
                                        Bidan</option>
                                    <option value="Dokter Umum"
                                        {{ old('penolong_persalinan') === 'Dokter Umum' ? 'selected' : '' }}>Dokter
                                        Umum
                                    </option>
                                    <option value="Dokter SpOG"
                                        {{ old('penolong_persalinan') === 'Dokter SpOG' ? 'selected' : '' }}>Dokter
                                        SpOG
                                    </option>
                                    <option value="lainnya"
                                        {{ old('penolong_persalinan') === 'lainnya' ? 'selected' : '' }}>Lainnya
                                    </option>
                                </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('lainya_penolong_persalinan') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('tmpt_persalinan') is-invalid @enderror"
                                    ...
                                    <option value="Puskesmas"
                                        {{ old('tmpt_persalinan') === 'Puskesmas' ? 'selected' : '' }}>
                                        Puskesmas</option>
                                    <option value="Rumah Sakit"
                                        {{ old('tmpt_persalinan') === 'Rumah Sakit' ? 'selected' : '' }}>
                                        Rumah Sakit</option>
                                    <option value="Klinik" {{ old('tmpt_persalinan') === 'Klinik' ? 'selected' : '' }}>
                                        Klinik</option>
                                    <option value="Praktik Bidan Mandiri"
                                        {{ old('tmpt_persalinan') === 'Praktik Bidan Mandiri' ? 'selected' : '' }}>
                                        Praktik Bidan Mandiri</option>
                                    <option value="Rumah" {{ old('tmpt_persalinan') === 'Rumah' ? 'selected' : '' }}>
                                        Rumah</option>
                                    <option value="lainnya" {{ old('tmpt_persalinan') === 'lainnya' ? 'selected' : '' }}>
                                        Lainnya</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('nama_tmpt_persalinan') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('cara_persalinan') is-invalid @enderror"
                                        ...
                                        <option value="Persalinan Normal"
                                            {{ old('cara_persalinan') === 'Persalinan Normal' ? 'selected' : '' }}>
                                            Persalinan Normal</option>
                                        <option value="Persalinan Dengan Tindakan"
                                            {{ old('cara_persalinan') === 'Persalinan Dengan Tindakan' ? 'selected' : '' }}>
                                            Persalinan Dengan Tindakan</option>
                                        <option value="lainnya"
                                            {{ old('cara_persalinan') === 'lainnya' ? 'selected' : '' }}>
                                            Lainnya</option>
                                    </select>
                                    <div class="form-group">
                                        <input type="text"
                                            ...
                                            placeholder="Lainnya" autocomplete="off"
                                            value="{{ old('lainya_cara_persalinan') }}"
                                            data-old="{{ old('lainya_cara_persalinan') }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('keadaan_ibu_persalinan') is-invalid @enderror"
                                    ...
                                    <option value="Sehat"
                                        {{ old('keadaan_ibu_persalinan') === 'Sehat' ? 'selected' : '' }}>
                                        Sehat</option>
                                    <option value="Sakit (Pendarahan/Demam/Kejang/Lokhia Berbau/Lain-lain)"
                                        {{ old('keadaan_ibu_persalinan') === 'Sakit (Pendarahan/Demam/Kejang/Lokhia Berbau/Lain-lain)' ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('riwayat_imd_persalinan') is-invalid @enderror"
                                    ...
                                    <option value="Ya" {{ old('riwayat_imd_persalinan') === 'Ya' ? 'selected' : '' }}>
                                        Ya</option>
                                    <option value="Tidak"
                                        {{ old('riwayat_imd_persalinan') === 'Tidak' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <select class="form-control @error('buku_ka') is-invalid @enderror" name="buku_ka"
                                    id="buku_ka" required>
                                    <option value="">Pilih</option>
                                    <option value="Ada" {{ old('buku_ka') == 'Ada' ? 'selected' : '' }}>Ada
                                    </option>
                                    <option value="Tidak" {{ old('buku_ka') == 'Tidak' ? 'selected' : '' }}>Tidak
                                    </option>
                                </select>
                                @error('buku_ka')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <h5>Ibu memeriksa kesehatannya ke posyandu Prima/ Puskesmas/
                                    Fasyankes lainnya atau kunjungan rumah oleh nakes dan untuk melakukan
                                    pemeriksaan
                            ...
                            <div class="form-group">
                                <select class="form-control @error('pemeriksaan_kesehatan') is-invalid @enderror"
                                    ...
                                    <option value="KF1 (6 Jam - 48 Jam)"
                                        {{ old('pemeriksaan_kesehatan') === 'KF1 (6 Jam - 48 Jam)' ? 'selected' : '' }}>
                                        KF1 (6 Jam - 48 Jam)</option>
                                    <option value="KF2 (3 - 7 Hari Pasca Persalinan)"
                                        {{ old('pemeriksaan_kesehatan') === 'KF2 (3 - 7 Hari Pasca Persalinan)' ? 'selected' : '' }}>
                                        KF2 (3 - 7 Hari Pasca Persalinan)</option>
                                    <option value="KF3 (8 - 28 Hari Pasca Persalinan)"
                                        {{ old('pemeriksaan_kesehatan') === 'KF3 (8 - 28 Hari Pasca Persalinan)' ? 'selected' : '' }}>
                                        KF3 (8 - 28 Hari Pasca Persalinan)</option>
                                    <option value="KF4 (29 - 42 Hari Pasca Persalinan)"
                                        {{ old('pemeriksaan_kesehatan') === 'KF4 (29 - 42 Hari Pasca Persalinan)' ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('tempat_pk') is-invalid @enderror" name="tempat_pk"
                                    ...
                                    <option value="Rumah Sakit"
                                        {{ old('tempat_pk') === 'Rumah Sakit' ? 'selected' : '' }}>
                                        Rumah Sakit</option>
                                    <option value="Puskesmas" {{ old('tempat_pk') === 'Puskesmas' ? 'selected' : '' }}>
                                        Puskesmas</option>
                                    <option value="Polindes" {{ old('tempat_pk') === 'Polindes' ? 'selected' : '' }}>
                                        Polindes</option>
                                    <option value="BPM" {{ old('tempat_pk') === 'BPM' ? 'selected' : '' }}>
                                        BPM</option>
                                    <option value="Rumah" {{ old('tempat_pk') === 'Rumah' ? 'selected' : '' }}>
                                        Rumah</option>
                                </select>
                                @error('tempat_pk')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('petugas_pk') is-invalid @enderror" name="petugas_pk"
                                    ...
                                    <option value="Dokter" {{ old('petugas_pk') === 'Dokter' ? 'selected' : '' }}>
                                        Dokter</option>
                                    <option value="Bidan" {{ old('petugas_pk') === 'Bidan' ? 'selected' : '' }}>
                                        Bidan</option>
                                    <option value="Perawat" {{ old('petugas_pk') === 'Perawat' ? 'selected' : '' }}>
                                        Perawat</option>
                                    <option value="Kader" {{ old('petugas_pk') === 'Kader' ? 'selected' : '' }}>
                                        Kader</option>
                                </select>
                                @error('petugas_pk')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <select class="form-control @error('porsi') is-invalid @enderror" name="porsi"
                                    ...
                                    <option value="Tidak" {{ old('porsi') === 'Tidak' ? 'selected' : '' }}>Tidak
                                    </option>
                                </select>
                                @error('porsi')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('ada_kva') is-invalid @enderror" name="ada_kva"
                                    ...
                                    <option value="Ya" {{ old('ada_kva') === 'Ya' ? 'selected' : '' }}>Ya
                                    </option>
                                    <option value="Tidak" {{ old('ada_kva') === 'Tidak' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                                @error('ada_kva')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('wkt_minum_kva') is-invalid @enderror"
                                    ...
                                    value="{{ old('wkt_minum_kva') }}" required>
                                @error('wkt_minum_kva')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('menyusui') is-invalid @enderror" name="menyusui"
                                    ...
                                    <option value="Ya" {{ old('menyusui') === 'Ya' ? 'selected' : '' }}>Ya
                                    </option>
                                    <option value="Tidak" {{ old('menyusui') === 'Tidak' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                                @error('menyusui')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('kb_pasca_persalinan') is-invalid @enderror"
                                    ...
                                    <option value="MOW" {{ old('kb_pasca_persalinan') === 'MOW' ? 'selected' : '' }}>
                                        MOW</option>
                                    <option value="IUD" {{ old('kb_pasca_persalinan') === 'IUD' ? 'selected' : '' }}>
                                        IUD</option>
                                    <option value="Implan"
                                        {{ old('kb_pasca_persalinan') === 'Implan' ? 'selected' : '' }}>
                                        Implan</option>
                                    <option value="Suntik"
                                        {{ old('kb_pasca_persalinan') === 'Suntik' ? 'selected' : '' }}>
                                        Suntik</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date"
                                    ...
                                    autocomplete="off" value="{{ old('skrining_kesehatan') }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('skrining_kesehatan_tmp') is-invalid @enderror"
                                    ...
                                    <option value="Rumah"
                                        {{ old('skrining_kesehatan_tmp') === 'Rumah' ? 'selected' : '' }}>
                                        Rumah</option>
                                    <option value="Posyandu"
                                        {{ old('skrining_kesehatan_tmp') === 'Posyandu' ? 'selected' : '' }}>
                                        Posyandu</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('skrining_kesehatan_petugas') is-invalid @enderror"
                                    ...
                                    <option value="Petugas Puskesmas"
                                        {{ old('skrining_kesehatan_petugas') === 'Petugas Puskesmas' ? 'selected' : '' }}>
                                        Petugas Puskesmas</option>
                                    <option value="Kader"
                                        {{ old('skrining_kesehatan_petugas') === 'Kader' ? 'selected' : '' }}>
                                        Kader</option>
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="date"
                                    ...
                                    value="{{ old('edukasi_kunjungan') }}" required>
                ...
                <div class="card" style="margin-top: 2%">
                    <div class="row" style="margin: 1%">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('demam') is-invalid @enderror" name="demam"
                                    ...
                                    <option value="Ya" {{ old('demam') === 'Ya' ? 'selected' : '' }}>Ya
                                    </option>
                                    <option value="Tidak" {{ old('demam') === 'Tidak' ? 'selected' : '' }}>Tidak
                                    </option>
                                </select>
                                @error('demam')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="perasaan">Ada perasaan bersalah, mudah menangis, kehilangan minat,
                                    gelisah,
                                ...
                                <select class="form-control @error('perasaan') is-invalid @enderror" name="perasaan"
                                    ...
                                    <option value="Ya" {{ old('perasaan') === 'Ya' ? 'selected' : '' }}>Ya
                                    </option>
                                    <option value="Tidak" {{ old('perasaan') === 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                                @error('perasaan')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="sakit">Tidak bisa BAK, BAK sedikit tapi sering, terasa panas, nyeri
                                    panggul,
                                ...
                                <select class="form-control @error('sakit') is-invalid @enderror" name="sakit"
                                    ...
                                    <option value="Ya" {{ old('sakit') === 'Ya' ? 'selected' : '' }}>Ya
                                    </option>
                                    <option value="Tidak" {{ old('sakit') === 'Tidak' ? 'selected' : '' }}>Tidak
                                    </option>
                                </select>
                                @error('sakit')
                                    <span class="text-danger">{{ $message }}</span>
                ...
                <div class="card" style="margin-top: 2%">
                    <div class="row" style="margin: 1%">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="pernafasan">Nafas pendek dan terengah-engah, nafas dangkal disertasi
                                    nyeri
                                ...
                                <select class="form-control @error('pernafasan') is-invalid @enderror" name="pernafasan"
                                    ...
                                    <option value="Ya" {{ old('pernafasan') === 'Ya' ? 'selected' : '' }}>Ya
                                    </option>
                                    <option value="Tidak" {{ old('pernafasan') === 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                                @error('pernafasan')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="payudara">Payudara bengkak kemerahan disertai nyeri, benjolan disertai
                                    nyeri
                                ...
                                <select class="form-control @error('payudara') is-invalid @enderror" name="payudara"
                                    ...
                                    <option value="Ya" {{ old('payudara') === 'Ya' ? 'selected' : '' }}>Ya
                                    </option>
                                    <option value="Tidak" {{ old('payudara') === 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                                @error('payudara')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('sakit_kepala') is-invalid @enderror"
                                    ...
                                    <option value="Ya" {{ old('sakit_kepala') === 'Ya' ? 'selected' : '' }}>
                                        Ya
                                    </option>
                                    <option value="Tidak" {{ old('sakit_kepala') === 'Tidak' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                                @error('sakit_kepala')
                                    <span class="text-danger">{{ $message }}</span>
                ...
                <div class="card" style="margin-top: 2%">
                    <div class="row" style="margin: 1%">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('pendarahan') is-invalid @enderror" name="pendarahan"
                                    ...
                                    <option value="Ya" {{ old('pendarahan') === 'Ya' ? 'selected' : '' }}>Ya
                                    </option>
                                    <option value="Tidak" {{ old('pendarahan') === 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                                @error('pendarahan')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="sakit_bagian_kelamin">Area sekitar kelamin bengkak atau nyeri atau ada
                                    luka
                                    terbuka</label>
                                <select class="form-control @error('sakit_bagian_kelamin') is-invalid @enderror"
                                    ...
                                    <option value="Ya" {{ old('sakit_bagian_kelamin') === 'Ya' ? 'selected' : '' }}>
                                        Ya</option>
                                    <option value="Tidak"
                                        {{ old('sakit_bagian_kelamin') === 'Tidak' ? 'selected' : '' }}>Tidak
                                    </option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('keluar_cairan') is-invalid @enderror"
                                    ...
                                    <option value="Ya" {{ old('keluar_cairan') === 'Ya' ? 'selected' : '' }}>
                                        Ya</option>
                                    <option value="Tidak" {{ old('keluar_cairan') === 'Tidak' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                                @error('keluar_cairan')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('pandangan_kabur') is-invalid @enderror"
                                    ...
                                    <option value="Ya" {{ old('pandangan_kabur') === 'Ya' ? 'selected' : '' }}>Ya
                                    </option>
                                    <option value="Tidak" {{ old('pandangan_kabur') === 'Tidak' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('darah_nifas') is-invalid @enderror"
                                    ...
                                    <option value="Ya" {{ old('darah_nifas') === 'Ya' ? 'selected' : '' }}>Ya
                                    </option>
                                    <option value="Tidak" {{ old('darah_nifas') === 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                                @error('darah_nifas')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('keputihan') is-invalid @enderror" name="keputihan"
                                    ...
                                    <option value="Ya" {{ old('keputihan') === 'Ya' ? 'selected' : '' }}>
                                        Ya</option>
                                    <option value="Tidak" {{ old('keputihan') === 'Tidak' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                                @error('keputihan')
                                    <span class="text-danger">{{ $message }}</span>
                ...
                <div class="card" style="margin-top: 2%">
                    <div class="row" style="margin: 1%">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('jantung_berdebar') is-invalid @enderror"
                                    ...
                                    <option value="Ya" {{ old('jantung_berdebar') === 'Ya' ? 'selected' : '' }}>
                                        Ya
                                    </option>
                                    <option value="Tidak" {{ old('jantung_berdebar') === 'Tidak' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="pengingat_periksa_postu">Mengingatkan periksa ke
                                    Postu/Fasyankes</label>
                                <select class="form-control @error('pengingat_periksa_postu') is-invalid @enderror"
                                    ...
                                    <option value="">Pilih</option>
                                    <option value="Ya"
                                        {{ old('pengingat_periksa_postu') === 'Ya' ? 'selected' : '' }}>Ya
                                    </option>
                                    <option value="Tidak"
                                        {{ old('pengingat_periksa_postu') === 'Tidak' ? 'selected' : '' }}>Tidak
                                    </option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date"
                                    ...
                                    autocomplete="off" value="{{ old('tgl_laporan_nakes') }}" required>
                    ...
                    {{-- <a href="{{ route('ibu_bersalin_nifas.index') }}" class="btn btn-default">Back to list</a> --}}
