...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('Tambah Data Kunjungan Rumah Bayi') }}</h1>
    ...
    <div class="card">
        <div class="progress">
            <div class="progress-bar" role="progressbar" style="width: 56%;" aria-valuenow="25" aria-valuemin="0"
                aria-valuemax="100">56%</div>
        </div>
        <div class="card-body">
            {{-- <form action="{{ route('kunjungan_rumah_bayi.store') }}" method="post" id="modal-save-form"> --}}
            <form action="{{ route('kunjungan_rumah_bayi.storebayi') }}" method="post" id="modal-save-form">
                @csrf
                ...
                <div class="card" style="margin-top: 2%">
                    ...
                    {{-- <a href="{{ route('ibu_hamil.index') }}" class="btn btn-default">Back to list</a> --}}
