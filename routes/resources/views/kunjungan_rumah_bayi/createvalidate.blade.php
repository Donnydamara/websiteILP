...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('kunjungan_rumah_bayi.storevalidate') }}" method="post" id="modal-save-form">
                @csrf
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('kk') is-invalid @enderror" name="kk"
                                    id="kk" placeholder="kk" value="{{ old('kk') }}" required readonly>
                                @error('kk')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                ...
                <div class="card" style="margin-top: 2%">
                    ...
                    {{-- <div class="row" style="margin: 1%">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="jenis_imunisasi"></label>
