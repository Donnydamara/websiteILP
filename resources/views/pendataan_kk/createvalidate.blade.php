...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('datakk.storevalidate') }}" method="post" id="modal-save-form">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        {{-- <div class="form-group">
                            <label for="kk">Kartu Keluarga</label>
                            <input type="number" class="form-control @error('kk') is-invalid @enderror" name="kk"
                                id="kk" placeholder="Kartu Keluarga" autocomplete="off" value="{{ old('kk') }}"
                                required>
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" type="button" id="btnCekData">Cek Data</button>
                            </div>
                            @error('kk')
                ...
                <a href="{{ route('datakk.index') }}" class="btn btn-default">Back to list</a>
