...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('kunjungan_lansia.update', ['id' => $kunjunganLansia->id]) }}" method="post"
                id="modal-save-form">
                @csrf
                @method('PUT')
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    ...
                                    value="{{ old('nama') ?? $kunjunganLansia->nama }}" required>
                                @error('nama')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('nik') is-invalid @enderror" name="nik"
                                    ...
                                    value="{{ old('nik') ?? $kunjunganLansia->nik }}" required>
                                @error('nik')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
