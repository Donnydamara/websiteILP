...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('List Data Ibu Bersalin Nifas') }}</h1>

    <!-- Main Content goes here -->

    {{-- <a href="{{ route('ibu_bersalin_nifas.createvalidate') }}" class="btn btn-primary mb-3">Tambah Data Ibu Hamil Baru</a> --}}
    {{-- <a href="{{ route('ibu_bersalin_nifas.create') }}" class="btn btn-primary mb-3">Tambah Data Ibu Hamil Baru</a> --}}
    <div class="row mb-3">
        <div class="col text-center">
            <!-- Tombol Tambah (untuk role 'kader') -->
            @if (Auth::check() && Auth::user()->role == 'kader')
                <button class="btn btn-primary mb-2"
                    onclick="window.location.href='{{ route('ibu_bersalin_nifas.createvalidate') }}'">
                    Tambah Data
                </button>
            @endif
            ...
            <form method="GET" action="{{ route('ibu_bersalin_nifas.index') }}" class="d-inline mb-2">
            ...
            <form method="GET" action="{{ route('ibu_bersalin_nifas.export', ['status' => 'ya', 'export' => 'true']) }}"
                class="d-inline">
        ...
        <table class="table table-bordered table-striped" id="dataTable">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center">Kelahiran Ke</th>
                    <th style="text-align: center">Aksi</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($ibuhamilNifass as $dataKK)
                    <tr>
                        ...
                        <td>{{ $dataKK->kelahiran_ke }}</td>
                        <td>
                            <div class="d-flex">
                                @if (Auth::check() && Auth::user()->role == 'kader')
                                    <form action="{{ route('ibu_bersalin_nifas.edit', ['id' => $dataKK->id]) }}"
                                    ...
                                    {{-- <a href="{{ route('ibu_bersalin_nifas.edit', ['id' => $dataKK->id]) }}"
                                    class="btn btn-sm btn-primary mr-2">Edit</a> --}}
                                    <form action="{{ route('ibu_bersalin_nifas.destroy', ['id' => $dataKK->id]) }}"
                                ...
                                <form action="{{ route('ibu_bersalin_nifas.show', ['id' => $dataKK->id]) }}" method="GET"
                                ...
                                {{-- <a href="{{ route('ibu_bersalin_nifas.show', ['id' => $dataKK->id]) }}"
