...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('Tambah Kunjungan Usia Sekolah') }}</h1>

    <!-- Main Content goes here -->

    <div class="card">
        <div class="card-body">
            <form action="{{ route('kunjungan_usia_sekolah.store2') }}" method="POST" id="modal-save-form">
                @csrf
                ...
                <div class="card" style="margin-top: 2%">
                    ...
                    @if (isset($kk))
                        <a href="{{ url()->previous() }}" class="btn btn-default">Kembali Ke Detail</a>
                    @endif
                </div>
