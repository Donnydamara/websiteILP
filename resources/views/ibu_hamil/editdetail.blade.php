...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('Update Data Ibu Hamil') }}</h1>
    ...
    <div class="card" style="text-align: center">
        <div class="card-body">
            ...
            <form action="{{ route('ibu_hamil.updatedetail', ['id' => $ibu_hamil->id]) }}" method="post" id="modal-save-form">
                @csrf
                @method('PUT')
                <div class="form-group">
                    ...
                    <select class="form-control @error('status') is-invalid @enderror" name="status" id="status"
                        ...
                        <option value="Ya" {{ old('status') ?? $ibu_hamil->status === 'Ya' ? 'selected' : '' }}>Ya
                        </option>
                        <option value="Tidak" {{ old('status') ?? $ibu_hamil->status === 'Tidak' ? 'selected' : '' }}>
                            Tidak</option>
                        <option value="Selesai" {{ old('status') ?? $ibu_hamil->status === 'Selesai' ? 'selected' : '' }}>
                            Selesai
                        </option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('kk') is-invalid @enderror" name="kk"
                                    ...
                                    value="{{ old('kk') ?? $ibu_hamil->kk }}" required readonly>
                                @error('kk')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    ...
                                    value="{{ old('nama') ?? $ibu_hamil->nama }}" required>
                                @error('nama')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('nik') is-invalid @enderror" name="nik"
                                    ...
                                    value="{{ old('nik') ?? $ibu_hamil->nik }}" required>
                                @error('nik')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('kehamilan_ke') is-invalid @enderror"
                                    ...
                                    value="{{ old('kehamilan_ke') ?? $ibu_hamil->kehamilan_ke }}" required>
                                @error('kehamilan_ke')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="jarak_kehamilan_unit" name="jarak_kehamilan_unit"
                                    ...
                                    <option value="bulan"
                                        {{ (old('jarak_kehamilan_unit') ?? $ibu_hamil->jarak_kehamilan_unit) == 'bulan' ? 'selected' : '' }}>
                                        Bulan
                                    </option>
                                    <option value="tahun"
                                        {{ (old('jarak_kehamilan_unit') ?? $ibu_hamil->jarak_kehamilan_unit) == 'tahun' ? 'selected' : '' }}>
                                        Tahun
                                    </option>
                                </select>
                                ...
                                <input type="number"
                                    ...
                                    value="{{ old('jarak_kehamilan_bulan') ?? $ibu_hamil->jarak_kehamilan_bulan }}"
                                    {{ (old('jarak_kehamilan_unit') ?? $ibu_hamil->jarak_kehamilan_unit) == 'tahun' ? 'class=d-none' : '' }}>

                                <input type="number"
                                    class="form-control mt-2 @error('jarak_kehamilan_tahun') is-invalid @enderror"
                                    name="jarak_kehamilan_tahun" id="jarak_kehamilan_tahun"
                                    placeholder="Masukkan dalam tahun" autocomplete="off"
                                    value="{{ old('jarak_kehamilan_tahun') ?? $ibu_hamil->jarak_kehamilan_tahun }}"
                                    {{ (old('jarak_kehamilan_unit') ?? $ibu_hamil->jarak_kehamilan_unit) == 'bulan' ? 'class=d-none' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('umur') is-invalid @enderror"
                                    ...
                                    value="{{ old('umur') ?? $ibu_hamil->umur }}" required>
                                @error('umur')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('kunjungan') is-invalid @enderror"
                                    ...
                                    value="{{ old('kunjungan') ?? $ibu_hamil->kunjungan }}" required>
                                @error('kunjungan')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tgl_kunjungan') is-invalid @enderror"
                                    ...
                                    autocomplete="off" value="{{ old('tgl_kunjungan') ?? $ibu_hamil->kunjungan }}"
                                    required>
                                @error('tgl_kunjungan')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('suhu_tubuh') is-invalid @enderror" name="suhu_tubuh"
                                    ...
                                    <option value="<37,5 C" {{ $ibu_hamil->suhu_tubuh == '<37,5 C' ? 'selected' : '' }}>
                                        &lt;
                                        37,5 C
                                    </option>
                                    <option value=">37,5 C" {{ $ibu_hamil->suhu_tubuh == '>37,5 C' ? 'selected' : '' }}>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <select class="form-control @error('kia') is-invalid @enderror" name="kia"
                                    ...
                                    <option value="Ada" {{ $ibu_hamil->kia == 'Ada' ? 'selected' : '' }}>Ada
                                    </option>
                                    <option value="Tidak" {{ $ibu_hamil->kia == 'Tidak' ? 'selected' : '' }}>Tidak
                                    </option>
                                </select>
                                @error('kia')
                                    <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('jenis_imk') is-invalid @enderror"
                                        ...
                                        <option value="K1 (Trimester I (1 kali pada umur kehamilan hingga 12 minggu))"
                                            {{ old('jenis_imk') ?? $ibu_hamil->jenis_imk == 'K1 (Trimester I (1 kali pada umur kehamilan hingga 12 minggu))' ? 'selected' : '' }}>
                                        ...
                                        <option
                                            ...
                                            {{ old('jenis_imk') ?? $ibu_hamil->jenis_imk == 'K2 (Trimester II (2 kali pada umur kehamilan hingga 12 - 24 minggu))' ? 'selected' : '' }}>
                                        ...
                                        <option
                                            ...
                                            {{ old('jenis_imk') ?? $ibu_hamil->jenis_imk == 'K3 (Trimester II (2 kali pada umur kehamilan hingga 12 - 24 minggu))' ? 'selected' : '' }}>
                                        ...
                                        <option
                                            ...
                                            {{ old('jenis_imk') ?? $ibu_hamil->jenis_imk == 'K4 (Trimester III (3 kali pada umur kehamilan hingga 24 - 40 minggu))' ? 'selected' : '' }}>
                                        ...
                                        <option
                                            ...
                                            {{ old('jenis_imk') ?? $ibu_hamil->jenis_imk == 'K5 (Trimester III (3 kali pada umur kehamilan hingga 24 - 40 minggu))' ? 'selected' : '' }}>
                                        ...
                                        <option
                                            ...
                                            {{ old('jenis_imk') ?? $ibu_hamil->jenis_imk == 'K6 (Trimester III (3 kali pada umur kehamilan hingga 24 - 40 minggu))' ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('tgl_imk') is-invalid @enderror"
                                        ...
                                        value="{{ old('tgl_imk') ?? $ibu_hamil->tgl_imk }}" required>
                                    @error('tgl_imk')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tempat_imk') is-invalid @enderror"
                                        ...
                                        <option value="Rumah sakit"
                                            {{ $ibu_hamil->tempat_imk == 'Rumah sakit' ? 'selected' : '' }}>Rumah
                                            sakit</option>
                                        <option value="Puskesmas"
                                            {{ $ibu_hamil->tempat_imk == 'Puskesmas' ? 'selected' : '' }}>
                                            Puskesmas</option>
                                        <option value="Polindes"
                                            {{ $ibu_hamil->tempat_imk == 'Polindes' ? 'selected' : '' }}>
                                            Polindes</option>
                                        <option value="Dokter Praktik"
                                            {{ $ibu_hamil->tempat_imk == 'Dokter Praktik' ? 'selected' : '' }}>
                                            Dokter Praktik
                                        </option>
                                        <option value="Bidan praktik mandiri"
                                            {{ $ibu_hamil->tempat_imk == 'Bidan praktik mandiri' ? 'selected' : '' }}>Bidan
                                            praktik
                                            mandiri</option>
                                        <option value="Kader" {{ $ibu_hamil->tempat_imk == 'Kader' ? 'selected' : '' }}>
                                            Rumah
                                        </option>
                                    </select>
                                    @error('tempat_imk')
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('petugas_imk') is-invalid @enderror"
                                        ...
                                        <option value="docter"
                                            {{ $ibu_hamil->petugas_imk == 'docter' ? 'selected' : '' }}>
                                            Docter
                                        </option>
                                        <option value="bidan" {{ $ibu_hamil->petugas_imk == 'bidan' ? 'selected' : '' }}>
                                            Bidan
                                        </option>
                                        <option value="perawat"
                                            {{ $ibu_hamil->petugas_imk == 'perawat' ? 'selected' : '' }}>
                                            Perawat</option>
                                        <option value="Kader" {{ $ibu_hamil->petugas_imk == 'Kader' ? 'selected' : '' }}>
                                            Kader</option>
                                    </select>
                                    @error('petugas_imk')
                                        <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('ada_ttd') is-invalid @enderror" name="ada_ttd"
                                        id="ada_ttd" required>
                                        <option value="">Pilih Opsi</option>
                                        <option value="Ada" {{ $ibu_hamil->ada_ttd == 'Ada' ? 'selected' : '' }}>Ada
                                        </option>
                                        <option value="Tidak" {{ $ibu_hamil->ada_ttd == 'Tidak' ? 'selected' : '' }}>
                                            Tidak
                                        </option>
                                    </select>
                                    @error('ada_ttd')
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('minum_ttd') is-invalid @enderror"
                                        ...
                                        <option value="">Pilih Opsi</option>
                                        <option value="Ada" {{ $ibu_hamil->minum_ttd == 'Ada' ? 'selected' : '' }}>
                                            Ada
                                        </option>
                                        <option value="Tidak" {{ $ibu_hamil->minum_ttd == 'Tidak' ? 'selected' : '' }}>
                                            Tidak
                                        </option>
                                    </select>
                                    @error('minum_ttd')
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('porsi') is-invalid @enderror" name="porsi"
                                        id="porsi" required>
                                        <option value="">Pilih Opsi</option>
                                        <option value="Sesuai" {{ $ibu_hamil->porsi == 'Sesuai' ? 'selected' : '' }}>
                                            Sesuai
                                        </option>
                                        <option value="Tidak" {{ $ibu_hamil->porsi == 'Tidak' ? 'selected' : '' }}>Tidak
                                        </option>
                                    </select>
                                    @error('porsi')
                                        <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="form-group">
                                <label for="lila">LILA < 23,4 cm</label>
                                        <select class="form-control @error('lila') is-invalid @enderror" name="lila"
                                            id="lila" required>
                                            <option value="">Pilih Opsi</option>
                                            <option value="Ada" {{ $ibu_hamil->lila == 'Ada' ? 'selected' : '' }}>
                                                Ada
                                            </option>
                                            <option value="Tidak" {{ $ibu_hamil->lila == 'Tidak' ? 'selected' : '' }}>
                                                Tidak
                                            </option>
                                        </select>
                                        @error('lila')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('pmt') is-invalid @enderror" name="pmt"
                                    id="pmt" required>
                                    <option value="">Pilih Opsi</option>
                                    <option value="Ada" {{ $ibu_hamil->pmt == 'Ada' ? 'selected' : '' }}>Ada
                                    </option>
                                    <option value="Tidak" {{ $ibu_hamil->pmt == 'Tidak' ? 'selected' : '' }}>Tidak
                                    </option>
                                </select>
                                @error('pmt')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('kls_ibu_hamil') is-invalid @enderror"
                                    ...
                                    autocomplete="off" value="{{ old('kls_ibu_hamil') ?? $ibu_hamil->kls_ibu_hamil }}"
                                    required>
                                @error('kls_ibu_hamil')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('tempat_ibu_hamil') is-invalid @enderror"
                                    ...
                                    <option value="Kantor desa"
                                        {{ $ibu_hamil->tempat_ibu_hamil == 'Kantor desa' ? 'selected' : '' }}>
                                        Kantor desa
                                    </option>
                                    <option value="posyandu"
                                        {{ $ibu_hamil->tempat_ibu_hamil == 'posyandu' ? 'selected' : '' }}>
                                        Posyandu</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('pendamping_ibu_hamil') is-invalid @enderror"
                                    ...
                                    <option value="suami"
                                        {{ $ibu_hamil->pendamping_ibu_hamil == 'suami' ? 'selected' : '' }}>
                                        Suami</option>
                                    <option value="saudara"
                                        {{ $ibu_hamil->pendamping_ibu_hamil == 'saudara' ? 'selected' : '' }}>
                                        Saudara
                                    </option>
                                </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('kls_skrining_kesehatan') ?? $ibu_hamil->kls_skrining_kesehatan }}"
                                        required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tempat_skrining_kesehatan') is-invalid @enderror"
                                        ...
                                        <option value="">Pilih Tempat</option>
                                        <option value="Rumah"
                                            {{ $ibu_hamil->tempat_skrining_kesehatan == 'Rumah' ? 'selected' : '' }}>Rumah
                                        </option>
                                        <option value="Posyandu"
                                            {{ $ibu_hamil->tempat_skrining_kesehatan == 'Posyandu' ? 'selected' : '' }}>
                                            Posyandu
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('petugas_skrining_kesehatan') is-invalid @enderror"
                                        ...
                                        <option value="Petugas Puskesmas"
                                            {{ $ibu_hamil->petugas_skrining_kesehatan == 'Petugas Puskesmas' ? 'selected' : '' }}>
                                            Petugas Puskesmas</option>
                                        <option value="Kader"
                                            {{ $ibu_hamil->petugas_skrining_kesehatan == 'Kader' ? 'selected' : '' }}>Kader
                                        </option>
                                    </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('edukasi') is-invalid @enderror"
                                    ...
                                    autocomplete="off" value="{{ old('edukasi') ?? $ibu_hamil->edukasi }}" required>
                                @error('edukasi')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('demam_l2') is-invalid @enderror" name="demam_l2"
                                    ...
                                    <option value="">Pilih Opsi</option>
                                    <option value="Ada" {{ $ibu_hamil->demam_l2 == 'Ada' ? 'selected' : '' }}>
                                        Ada
                                    </option>
                                    <option value="Tidak" {{ $ibu_hamil->demam_l2 == 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                                @error('demam_l2')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('sakit_kepala_l2') is-invalid @enderror"
                                    ...
                                    <option value="">Pilih Opsi</option>
                                    <option value="Ada" {{ $ibu_hamil->sakit_kepala_l2 == 'Ada' ? 'selected' : '' }}>
                                        Ada
                                    </option>
                                    <option value="Tidak" {{ $ibu_hamil->sakit_kepala_l2 == 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('sulit_tidur_l2') is-invalid @enderror"
                                    ...
                                    <option value="">Pilih Opsi</option>
                                    <option value="Ada" {{ $ibu_hamil->sulit_tidur_l2 == 'Ada' ? 'selected' : '' }}>
                                        Ada
                                    </option>
                                    <option value="Tidak" {{ $ibu_hamil->sulit_tidur_l2 == 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('diare_l2') is-invalid @enderror" name="diare_l2"
                                    ...
                                    <option value="">Pilih Opsi</option>
                                    <option value="Ada" {{ $ibu_hamil->diare_l2 == 'Ada' ? 'selected' : '' }}>
                                        Ada
                                    </option>
                                    <option value="Tidak" {{ $ibu_hamil->diare_l2 == 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                                @error('diare_l2')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('tbc_l2') is-invalid @enderror" name="tbc_l2"
                                    id="tbc_l2" required>
                                    <option value="">Pilih Opsi</option>
                                    <option value="Ada" {{ $ibu_hamil->tbc_l2 == 'Ada' ? 'selected' : '' }}>Ada
                                    </option>
                                    <option value="Tidak" {{ $ibu_hamil->tbc_l2 == 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                                @error('tbc_l2')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('gerakan_janin_l2') is-invalid @enderror"
                                    ...
                                    <option value="">Pilih Opsi</option>
                                    <option value="Ada" {{ $ibu_hamil->gerakan_janin_l2 == 'Ada' ? 'selected' : '' }}>
                                        Ada
                                    </option>
                                    <option value="Tidak"
                                        {{ $ibu_hamil->gerakan_janin_l2 == 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('jantung_sakit_l2') is-invalid @enderror"
                                    ...
                                    <option value="">Pilih Opsi</option>
                                    <option value="Ada" {{ $ibu_hamil->jantung_sakit_l2 == 'Ada' ? 'selected' : '' }}>
                                        Ada
                                    </option>
                                    <option value="Tidak"
                                        {{ $ibu_hamil->jantung_sakit_l2 == 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('keluar_cairan_l2') is-invalid @enderror"
                                    ...
                                    <option value="">Pilih Opsi</option>
                                    <option value="Ada" {{ $ibu_hamil->keluar_cairan_l2 == 'Ada' ? 'selected' : '' }}>
                                        Ada
                                    </option>
                                    <option value="Tidak"
                                        {{ $ibu_hamil->keluar_cairan_l2 == 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('kencing_manis_l2') is-invalid @enderror"
                                    ...
                                    <option value="">Pilih Opsi</option>
                                    <option value="Ada" {{ $ibu_hamil->kencing_manis_l2 == 'Ada' ? 'selected' : '' }}>
                                        Ada
                                    </option>
                                    <option value="Tidak"
                                        {{ $ibu_hamil->kencing_manis_l2 == 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('nyeri_perut_l2') is-invalid @enderror"
                                    ...
                                    <option value="">Pilih Opsi</option>
                                    <option value="Ada" {{ $ibu_hamil->nyeri_perut_l2 == 'Ada' ? 'selected' : '' }}>
                                        Ada
                                    </option>
                                    <option value="Tidak" {{ $ibu_hamil->nyeri_perut_l2 == 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('periksa_l2') is-invalid @enderror" name="periksa_l2"
                                    ...
                                    <option value="">Pilih Opsi</option>
                                    <option value="Ada" {{ $ibu_hamil->periksa_l2 == 'Ada' ? 'selected' : '' }}>
                                        Ada
                                    </option>
                                    <option value="Tidak" {{ $ibu_hamil->periksa_l2 == 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                                @error('periksa_l2')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('lapor_nakes') is-invalid @enderror"
                                    ...
                                    value="{{ old('lapor_nakes') ?? $ibu_hamil->lapor_nakes }}" required>
                                @error('lapor_nakes')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function toggleFormFields(status) {
                ...
                for (var key in fields) {
                    ...
                    if (!isActive) {
                        fields[key].value = ''; // Kosongkan nilai jika status adalah 'Tidak'
                    }
                }
            }
