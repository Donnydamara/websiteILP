...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('Tambah Data Lingkungan Rumah') }}</h1>
    ...
    <div class="card">
        <div class="progress">
            <div class="progress-bar" role="progressbar" style="width: 30%;" aria-valuenow="25" aria-valuemin="0"
                aria-valuemax="100">30%</div>
        </div>
        <div class="card-body">
            {{-- <form action="{{ route('lingkunganrumah.store') }}" method="post" id="modal-save-form"> --}}
            <form action="{{ route('lingkunganrumah.storeling') }}" method="post" id="modal-save-form">
                @csrf
                <div class="card">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('kk') is-invalid @enderror"
                                            name="kk" id="kk" value="{{ session('kk') }}" required>
                            ...
                            <div class="row" style="margin: 1%">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            class="form-control @error('AK_balita') is-invalid @enderror" name="AK_balita"
                                            id="AK_balita" placeholder="Jumlah Anggota Keluarga Balita (6 - 7 Bulan)"
                                            autocomplete="off" value="{{ old('AK_balita') }}" required>
                                        @error('AK_balita')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
