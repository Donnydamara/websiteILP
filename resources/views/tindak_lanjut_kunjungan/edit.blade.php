...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('Edit Data Daftar Tindak Lanjut Kunjungan Rumah') }}</h1>

    <!-- Main Content goes here -->

    <div class="card">
        <div class="card-body">
            <form action="{{ route('tindak_lanjut_kunjungan.update', $tindakLanjutKunjungan->id) }}" method="post"
                id="modal-save-form">
                @csrf
                @method('PUT')
                <div class="form-group">
                    ...
                    <select class="form-control @error('status') is-invalid @enderror" name="status" id="status" required>
                        ...
                        <option value="Ya"
                            {{ old('status') ?? $tindakLanjutKunjungan->status === 'Ya' ? 'selected' : '' }}>Ya
                        </option>
                        <option value="Selesai"
                            {{ old('status') ?? $tindakLanjutKunjungan->status === 'Selesai' ? 'selected' : '' }}>
                            Selesai</option>
                    </select>
                    @error('status')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('posyandu') is-invalid @enderror"
                                name="posyandu" id="posyandu"
                                value="{{ old('posyandu', $tindakLanjutKunjungan->posyandu) }}" required readonly>
                            @error('posyandu')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('nik') is-invalid @enderror" name="nik"
                                    id="nik" value="{{ old('nik', $tindakLanjutKunjungan->nik) }}" required readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                                id="nama" value="{{ old('nama', $tindakLanjutKunjungan->nama) }}" required readonly>
                            @error('nama')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control @error('waktu') is-invalid @enderror"
                                name="waktu" id="waktu" value="{{ old('waktu', $tindakLanjutKunjungan->waktu) }}"
                                required>
                            @error('waktu')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tgl_lahir') is-invalid @enderror"
                                ...
                                value="{{ old('tgl_lahir', $tindakLanjutKunjungan->tgl_lahir) }}" required readonly>
                            @error('tgl_lahir')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" rows="2"
                                required readonly>{{ old('alamat', $tindakLanjutKunjungan->alamat) }}</textarea>
                            @error('alamat')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('no_telepon') is-invalid @enderror"
                                ...
                                value="{{ old('no_telepon', $tindakLanjutKunjungan->no_telepon) }}" required>
                            @error('no_telepon')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('masalah_kesehatan_yang_ditemukan') is-invalid @enderror"
                                name="masalah_kesehatan_yang_ditemukan" id="masalah_kesehatan_yang_ditemukan" rows="2" required>{{ old('masalah_kesehatan_yang_ditemukan', $tindakLanjutKunjungan->masalah_kesehatan_yang_ditemukan) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('tindak_lanjut') is-invalid @enderror" name="tindak_lanjut" id="tindak_lanjut"
                        rows="2" required>{{ old('tindak_lanjut', $tindakLanjutKunjungan->tindak_lanjut) }}</textarea>
                    @error('tindak_lanjut')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('edukasi') is-invalid @enderror" name="edukasi"
                                ...
                                <option value="">Pilih</option>
                                <option value="Ya"
                                    {{ old('edukasi', $tindakLanjutKunjungan->edukasi) == 'Ya' ? 'selected' : '' }}>Ya
                                </option>
                                <option value="Tidak"
                                    {{ old('edukasi', $tindakLanjutKunjungan->edukasi) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                            </select>
                            @error('edukasi')
                                <span class="invalid-feedback">{{ $message }}</span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('lapor_nakes') is-invalid @enderror" name="lapor_nakes"
                                ...
                                <option value="">Pilih</option>
                                <option value="Ya"
                                    {{ old('lapor_nakes', $tindakLanjutKunjungan->lapor_nakes) == 'Ya' ? 'selected' : '' }}>
                                    Ya</option>
                                <option value="Tidak"
                                    {{ old('lapor_nakes', $tindakLanjutKunjungan->lapor_nakes) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                            </select>
                            @error('lapor_nakes')
                                <span class="invalid-feedback">{{ $message }}</span>
                ...
                <button type="submit" class="btn btn-primary" onclick="showLoading()">Update</button>
