...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('Tambah Data Ibu Hamil') }}</h1>
    ...
    <div class="card" style="text-align: center">
        <div class="progress">
            <div class="progress-bar" role="progressbar" style="width: 39%;" aria-valuenow="25" aria-valuemin="0"
                aria-valuemax="100">39%</div>
        </div>
        <div class="card-body" style="text-align: center;">
            {{-- <form action="{{ route('ibu_hamil.store') }}" method="post" id="modal-save-form"> --}}
            <form action="{{ route('ibu_hamil.storeibuham') }}" method="post" id="modal-save-form">
                @csrf
                    ...
                    <div class="row" style="margin: 1%">
                        ...
                        {{-- <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('jarak_kehamilan') is-invalid @enderror"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('petugas_imk') is-invalid @enderror"
                                        ...
                                        <option value="bidan" {{ old('petugas_imk') == 'bidan' ? 'selected' : '' }}>Bidan
                                        </option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tempat_skrining_kesehatan') is-invalid @enderror"
                                        ...
                                        <option value="Posyandu"
                                            {{ old('tempat_skrining_kesehatan') == 'Posyandu' ? 'selected' : '' }}>Posyandu
                                        </option>
                                    </select>
