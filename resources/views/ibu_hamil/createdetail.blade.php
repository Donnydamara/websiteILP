...
@section('content')
    ...
    <div class="card" style="text-align: center">
        <div class="card-body" style="text-align: center;">
            <form action="{{ route('ibu_hamil.store2') }}" method="POST" id="modal-save-form">
                @csrf
                    ...
                    <div class="row" style="margin: 1%">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('Kartu Keluarga') is-invalid @enderror"
                                    name="kk" id="kk" value="{{ old('kk', $kk) }}" required readonly>
                                @error('kk')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row" style="margin: 1%">
                            ...
                            {{-- <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        class="form-control @error('jarak_kehamilan') is-invalid @enderror"
                                        name="jarak_kehamilan" id="jarak_kehamilan"
                                        placeholder="Jarak Kehamilan Dengan kehamilan Sebelumnya" autocomplete="off"
                        ...
                        <div class="row" style="margin: 1%">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('suhu_tubuh') is-invalid @enderror"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('tempat_imk') is-invalid @enderror"
                                            ...
                                            <option value="Rumah sakit"
                                                {{ old('tempat_imk') == 'Rumah sakit' ? 'selected' : '' }}>Rumah sakit
                                            </option>
                                            <option value="Puskesmas"
                                                {{ old('tempat_imk') == 'Puskesmas' ? 'selected' : '' }}>
                                                Puskesmas</option>
                                            <option value="Polindes"
                                                {{ old('tempat_imk') == 'Polindes' ? 'selected' : '' }}>
                                                Polindes</option>
                                            <option value="Dokter Praktik"
                                                {{ old('tempat_imk') == 'Dokter Praktik' ? 'selected' : '' }}>Dokter
                                                Praktik
                                            </option>
                                            <option value="Bidan praktik mandiri"
                                                ...
                                                praktik
                                                mandiri</option>
                                            <option value="Kader" {{ old('tempat_imk') == 'Kader' ? 'selected' : '' }}>
                                                Rumah
                                            </option>
                                        </select>
                                        @error('tempat_imk')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('petugas_imk') is-invalid @enderror"
                                            ...
                                            <option value="perawat"
                                                {{ old('petugas_imk') == 'perawat' ? 'selected' : '' }}>
                                                Perawat</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('ada_ttd') is-invalid @enderror"
                                            name="ada_ttd" id="ada_ttd" required>
                                            <option value="">Pilih Opsi</option>
                                            <option value="Ada" {{ old('ada_ttd') == 'Ada' ? 'selected' : '' }}>Ada
                                            </option>
                                            <option value="Tidak" {{ old('ada_ttd') == 'Tidak' ? 'selected' : '' }}>Tidak
                                            </option>
                                        </select>
                                        @error('ada_ttd')
                                            <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('porsi') is-invalid @enderror" name="porsi"
                                            id="porsi" required>
                                            <option value="">Pilih Opsi</option>
                                            <option value="Sesuai" {{ old('porsi') == 'Sesuai' ? 'selected' : '' }}>Sesuai
                                            </option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="lila">LILA < 23,4 cm</label>
                                            <select class="form-control @error('lila') is-invalid @enderror"
                        ...
                        <div class="row" style="margin: 1%">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        class="form-control @error('kls_ibu_hamil') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tempat_ibu_hamil') is-invalid @enderror"
                                        ...
                                        <option value="Kantor desa"
                                            {{ old('tempat_ibu_hamil') == 'Kantor desa' ? 'selected' : '' }}>Kantor desa
                                        </option>
                                        <option value="posyandu"
                                            {{ old('tempat_ibu_hamil') == 'posyandu' ? 'selected' : '' }}>Posyandu</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('pendamping_ibu_hamil') is-invalid @enderror"
                                        ...
                                        <option value="suami"
                                            {{ old('pendamping_ibu_hamil') == 'suami' ? 'selected' : '' }}>
                                            Suami</option>
                                        <option value="saudara"
                                            {{ old('pendamping_ibu_hamil') == 'saudara' ? 'selected' : '' }}>Saudara
                                        </option>
                                    </select>
                            ...
                            <div class="row" style="margin: 1%">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select
                                            class="form-control @error('tempat_skrining_kesehatan') is-invalid @enderror"
                                            name="tempat_skrining_kesehatan" id="tempat_skrining_kesehatan" required>
                                            <option value="">Pilih Tempat</option>
                                            <option value="Rumah"
                                                {{ old('tempat_skrining_kesehatan') == 'Rumah' ? 'selected' : '' }}>Rumah
                                            </option>
                                            <option value="Posyandu"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select
                                            class="form-control @error('petugas_skrining_kesehatan') is-invalid @enderror"
                                            ...
                                            <option value="Kader"
                                                {{ old('petugas_skrining_kesehatan') == 'Kader' ? 'selected' : '' }}>Kader
                                            </option>
                                        </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('gerakan_janin_l2') is-invalid @enderror"
                                        ...
                                        <option value="Tidak"
                                            {{ old('gerakan_janin_l2') == 'Tidak' ? 'selected' : '' }}>
                                            Tidak
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('jantung_sakit_l2') is-invalid @enderror"
                                        ...
                                        <option value="Tidak"
                                            {{ old('jantung_sakit_l2') == 'Tidak' ? 'selected' : '' }}>
                                            Tidak
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('keluar_cairan_l2') is-invalid @enderror"
                                        ...
                                        <option value="Tidak"
                                            {{ old('keluar_cairan_l2') == 'Tidak' ? 'selected' : '' }}>
                                            Tidak
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('kencing_manis_l2') is-invalid @enderror"
                                        ...
                                        <option value="Tidak"
                                            {{ old('kencing_manis_l2') == 'Tidak' ? 'selected' : '' }}>
                                            Tidak
                                        </option>
                                    </select>
                        ...
                        <div class="row" style="margin: 1%">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('periksa_l2') is-invalid @enderror"
