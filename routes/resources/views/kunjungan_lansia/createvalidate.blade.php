...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('kunjungan_lansia.storevalidate') }}" method="post" id="modal-save-form">
                @csrf
                ...
                <div class="card" style="margin-top: 2%">
                    ...
                    <a href="{{ route('kunjungan_lansia.index') }}" class="btn btn-default">Kembali Ke List</a>
                </div>
    ...
    <script>
        ...
        document.getElementById('btnCekData').addEventListener('click', function() {
            ...
            fetch('{{ route('kunjungan_lansia.checkKK') }}', {
                    method: 'POST',
                    headers: {
