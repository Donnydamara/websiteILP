...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('kunjungan_lansia', function (Blueprint $table) {
            ...
            $table->date('tgl_aks_skrining_geriatri')->nullable();
            $table->string('tmp_aks_skrining_geriatri')->nullable();
            $table->date('tgl_skilas_skrining_geriatri')->nullable();
            $table->string('tmp_skilas_skrining_geriatri')->nullable();
