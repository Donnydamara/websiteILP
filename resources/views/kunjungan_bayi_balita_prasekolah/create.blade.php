...
@section('content')
    ...
    <div class="card">
        <div class="progress">
            <div class="progress-bar" role="progressbar" style="width: 64%;" aria-valuenow="25" aria-valuemin="0"
                aria-valuemax="100">64%</div>
        </div>
        <div class="card-body">
            <form action="{{ route('kunjungan_bayi_balita_prasekolah.storeprase') }}" method="post" id="modal-save-form">
                @csrf
