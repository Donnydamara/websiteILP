...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('Tambah Data Kunjungan Lansia') }}</h1>
    ...
    <div class="card">
        ...
        <div class="card-body">
            {{-- <form action="{{ route('kunjungan_lansia.store') }}" method="post" id="modal-save-form"> --}}
            <form action="{{ route('kunjungan_lansia.storelan') }}" method="post" id="modal-save-form">
                @csrf
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('kk') is-invalid @enderror" name="kk"
                                    id="kk" placeholder="KK" value="{{ old('kk', $kk) }}" required>
                                @error('kk')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('minum_obat_terakhir_darah') is-invalid @enderror"
                                        ...
                                        <option value="" disabled selected>Pilih</option>
                                        <option value="Ada"
                                            {{ old('minum_obat_terakhir_darah') == 'Ada' ? 'selected' : '' }}>
                                            Ada</option>
                                        <option value="Tidak"
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="Posyandu"
                                            ...
                                            Posyandu</option>
                                        <option value="Rumah"
                                            {{ old('tmp_periksa_satu_tahun_gula_darah') == 'Rumah' ? 'selected' : '' }}>
                                            Rumah</option>
                                        <option value="Lainnya"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('obat_gula_darah_melitus') is-invalid @enderror"
                                        ...
                                        <option value="" disabled selected>Pilih</option>
                                        <option value="Ada"
                                            {{ old('obat_gula_darah_melitus') == 'Ada' ? 'selected' : '' }}>
                                            Ada</option>
                                        <option value="Tidak"
                                            {{ old('obat_gula_darah_melitus') == 'Tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="" disabled selected>Pilih</option>
                                        <option value="Ya"
                                            {{ old('minum_obat_gula_darah_melitus') == 'Ya' ? 'selected' : '' }}>
                                            Ya</option>
                                        <option value="Tidak"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        autocomplete="off" value="{{ old('tgl_aks_skrining_geriatri') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tmp_aks_skrining_geriatri') is-invalid @enderror"
                                        ...
                                        <option value="" disabled selected>Pilih Tempat</option>
                                        <option value="Puskesmas"
                                            {{ old('tmp_aks_skrining_geriatri') == 'Puskesmas' ? 'selected' : '' }}>
                                            Puskesmas</option>
                                        <option value="Polindes"
                                            {{ old('tmp_aks_skrining_geriatri') == 'Polindes' ? 'selected' : '' }}>
                                            Polindes</option>
                                        <option value="Posyandu"
                                            {{ old('tmp_aks_skrining_geriatri') == 'Posyandu' ? 'selected' : '' }}>
                                            Posyandu</option>
                                        <option value="Rumah"
                                            {{ old('tmp_aks_skrining_geriatri') == 'Rumah' ? 'selected' : '' }}>
                                            Rumah</option>
                                        <option value="Lainnya"
                                            {{ old('tmp_aks_skrining_geriatri') == 'Lainnya' ? 'selected' : '' }}>
                                            Lainnya</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        autocomplete="off" value="{{ old('tgl_skilas_skrining_geriatri') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="" disabled selected>Pilih Tempat</option>
                                        <option value="Puskesmas"
                                            {{ old('tmp_skilas_skrining_geriatri') == 'Puskesmas' ? 'selected' : '' }}>
                                            Puskesmas</option>
                                        <option value="Polindes"
                                            {{ old('tmp_skilas_skrining_geriatri') == 'Polindes' ? 'selected' : '' }}>
                                            Polindes</option>
                                        <option value="Posyandu"
                                            {{ old('tmp_skilas_skrining_geriatri') == 'Posyandu' ? 'selected' : '' }}>
                                            Posyandu</option>
                                        <option value="Rumah"
                                            {{ old('tmp_skilas_skrining_geriatri') == 'Rumah' ? 'selected' : '' }}>
                                            Rumah</option>
                                        <option value="Lainnya"
                                            {{ old('tmp_skilas_skrining_geriatri') == 'Lainnya' ? 'selected' : '' }}>
                                            Lainnya</option>
                                    </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('tmp_skrining') is-invalid @enderror"
                                    ...
                                    <option value="" disabled selected>Pilih Tempat</option>
                                    <option value="Puskesmas" {{ old('tmp_skrining') == 'Puskesmas' ? 'selected' : '' }}>
                                        Puskesmas</option>
                                    <option value="Polindes" {{ old('tmp_skrining') == 'Polindes' ? 'selected' : '' }}>
                                        Polindes</option>
                                    <option value="Posyandu" {{ old('tmp_skrining') == 'Posyandu' ? 'selected' : '' }}>
                                        Posyandu</option>
                                    <option value="Rumah" {{ old('tmp_skrining') == 'Rumah' ? 'selected' : '' }}>
                                        Rumah</option>
                                    <option value="Lainnya" {{ old('tmp_skrining') == 'Lainnya' ? 'selected' : '' }}>
                                        Lainnya</option>
                                </select>
                                @error('tmp_skrining')
                                    <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('petugas_skrining') is-invalid @enderror"
                                    ...
                                    <option value="Petugas Puskesmas"
                                        {{ old('petugas_skrining') == 'Petugas Puskesmas' ? 'selected' : '' }}>
                ...
                <div class="card" style="margin-top: 2%">
                    ...
                    {{-- <a href="{{ route('kunjungan_lansia.index') }}" class="btn btn-default">Back to list</a> --}}
                </div>
