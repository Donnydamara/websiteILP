...
<body>
    ...
    <table>
        ...
        <tbody aria-colspan="17">
            @if ($kunjunganusiadewasa->isNotEmpty())
                <tr>
                    <th colspan="3">Nama</th>
                    <td colspan="15">{{ $kunjunganusiadewasa[0]->nama }}</td>
                </tr>
                <tr>
                    <th colspan="3">Tempat / Tanggal Lahir</th>
                    <td colspan="15">{{ $kunjunganusiadewasa[0]->tmp_lahir }} /
                        {{ $kunjunganusiadewasa[0]->tgl_lahir }}</td>
                </tr>
                <tr>
                    <th colspan="3">Jenis Kelamin</th>
                    <td colspan="15">{{ $kunjunganusiadewasa[0]->gender }}</td>
                </tr>
                <tr>
                    <th colspan="3">Riwayat Penyakit Keluarga</th>
                    <td colspan="15">{{ $kunjunganusiadewasa[0]->riwayat_penyakit }}</td>
                </tr>
            @endif
            ...
            @foreach ($kunjunganusiadewasa as $member)
                <tr>
                    ...
                    <td rowspan="1" colspan="1" rowspan="3">{{ $member->jenis_kontrasepsi }}</td>
