...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('List Data Kunjungan Rumah Bayi') }}</h1>

    <!-- Main Content goes here -->

    {{-- <a href="{{ route('kunjungan_rumah_bayi.createvalidate') }}" class="btn btn-primary mb-3">Tambah Data Ibu Hamil Baru</a> --}}
    <div class="row mb-3">
        <div class="col text-center">
            <!-- Tombol Create untuk role 'kader' -->
            @if (Auth::check() && Auth::user()->role == 'kader')
                <button class="btn btn-primary mb-2"
                    onclick="window.location.href='{{ route('kunjungan_rumah_bayi.createvalidate') }}'">
                    <span>
            ...
            <form method="GET" action="{{ route('kunjungan_rumah_bayi.index') }}" class="d-inline mb-2">
            ...
            <form action="{{ route('kunjungan_rumah_bayi.export') }}" method="GET" class="d-inline">
    ...
    <div class="table-responsive" style="text-align: center">
        <table class="table table-bordered table-striped" id="dataTable">
            ...
            <tbody>
                @foreach ($kunjunganrumahBayis as $dataKK)
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                @if (Auth::check() && Auth::user()->role == 'kader')
                                    <form action="{{ route('kunjungan_rumah_bayi.edit', ['id' => $dataKK->id]) }}"
                                    ...
                                    <form action="{{ route('kunjungan_rumah_bayi.destroy', ['id' => $dataKK->id]) }}"
                                ...
                                @endif
                                {{-- <a href="{{ route('kunjungan_rumah_bayi.edit', ['id' => $dataKK->id]) }}"
                                ...
                                <form action="{{ route('kunjungan_rumah_bayi.show', ['id' => $dataKK->id]) }}"
                                    method="GET" style="display:inline;">
                                    @csrf
                                ...
                                {{-- <a href="{{ route('kunjungan_rumah_bayi.show', ['id' => $dataKK->id]) }}"
