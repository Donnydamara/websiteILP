...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('Data Keluarga Dan Anggota Keluarga') }}</h1>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('datakk.storekkpgs') }}" method="post" id="modal-save-form">
                @csrf
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                                ...
                                value="{{ session('kepala_kk') }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('kelompok_sasaran') is-invalid @enderror"
                                ...
                                <option value="Ibu Hamil" {{ old('kelompok_sasaran') == 'Ibu Hamil' ? 'selected' : '' }}>
                                    Ibu Hamil
                                </option>
                                ...
                                <option value="Usia Lansia (Usia 60 Tahun Keatas)"
                                    {{ old('kelompok_sasaran') == 'Usia Lansia (Usia 60 Tahun Keatas)' ? 'selected' : '' }}>
                ...
                <a href="{{ route('jadwal.index') }}" class="btn btn-default">Selesai</a>
                <!-- Button Tambah Data KK -->
                {{-- <button type="submit" class="btn btn-primary" onclick="setAction('save_and_add')">Tambah Data
                </button> --}}
