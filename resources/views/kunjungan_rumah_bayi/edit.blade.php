...
@section('content')
    ...
    <div class="card">
        <div class="card-body" tyle="text-align: center">
            <form action="{{ route('kunjungan_rumah_bayi.update', ['id' => $kunjunganrumahBayi->id]) }}" method="post"
                id="modal-save-form">
                @csrf
                @method('PUT')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('kk') is-invalid @enderror" name="kk"
                                    ...
                                    value="{{ old('kk') ?? $kunjunganrumahBayi->kk }}" required readonly>
                                @error('kk')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    ...
                                    value="{{ old('nama') ?? $kunjunganrumahBayi->nama }}" required>
                                @error('nama')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('nik') is-invalid @enderror" name="nik"
                                    ...
                                    value="{{ old('nik') ?? $kunjunganrumahBayi->nik }}" required>
                                @error('nik')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('napas') is-invalid @enderror" name="napas"
                                    id="napas" required>
                                    <option value="Ya"
                                        {{ (old('napas') ?? $kunjunganrumahBayi->napas) == 'Ya' ? 'selected' : '' }}>
                                        Ya
                                    </option>
                                    <option value="Tidak"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('kejang') is-invalid @enderror" name="kejang"
                                    id="kejang" required>
                                    <option value="Ya"
                                        {{ (old('kejang') ?? $kunjunganrumahBayi->kejang) == 'Ya' ? 'selected' : '' }}>
                                        Ya
                                    </option>
                                    <option value="Tidak"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('bab') is-invalid @enderror" name="bab"
                                    id="bab" required>
                                    <option value="Ya"
                                        {{ (old('bab') ?? $kunjunganrumahBayi->bab) == 'Ya' ? 'selected' : '' }}>
                                        Ya
                                    </option>
                                    <option value="Tidak"
                                        {{ (old('bab') ?? $kunjunganrumahBayi->bab) == 'Tidak' ? 'selected' : '' }}>
                                        Tidak
                                    </option>
                                </select>
                                @error('bab')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('mata') is-invalid @enderror" name="mata"
                                    id="mata" required>
                                    <option value="Ya"
                                        {{ (old('mata') ?? $kunjunganrumahBayi->mata) == 'Ya' ? 'selected' : '' }}>
                                        Ya
                                    </option>
                                    <option value="Tidak"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('kulit') is-invalid @enderror" name="kulit"
                                    id="kulit" required>
                                    <option value="Ya"
                                        {{ (old('kulit') ?? $kunjunganrumahBayi->kulit) == 'Ya' ? 'selected' : '' }}>
                                        Ya
                                    </option>
                                    <option value="Tidak"
                ...
                <div class="card" style="margin-top: 2%">
                    ...
                    <a href="{{ route('kunjungan_rumah_bayi.index') }}" class="btn btn-default">Kembali Ke
                        List</a>
                </div>
    ...
    <script>
        ...
        // updateFormFields(); // Panggil saat halaman pertama kali dimuat untuk mengatur tampilan awal
