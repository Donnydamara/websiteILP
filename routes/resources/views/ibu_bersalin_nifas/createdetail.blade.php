...
@section('content')
    ...
    <div class="card" style="text-align: center;">
        <div class="card-body">
            <form action="{{ route('ibu_bersalin_nifas.store2') }}" method="POST" id="modal-save-form">
                @csrf
                <div class="form-group">
                    ...
                    <select class="form-control @error('status') is-invalid @enderror" name="status" id="status"
                        ...
                        <option value="Ya" {{ old('status') === 'Ya' || old('status') === null ? 'selected' : '' }}>
                            Ya
                        </option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('kk') is-invalid @enderror" name="kk"
                                    id="kk" value="{{ old('kk', $kk) }}" required readonly>
                                @error('kk')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    name="nama" id="nama" value="{{ old('nama', $nama) }}" required readonly>
                                @error('nama')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
