...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('Tambah Data Kunjungan Usia Sekolah') }}</h1>
    ...
    <div class="card">
        <div class="progress">
            <div class="progress-bar" role="progressbar" style="width: 72%;" aria-valuenow="25" aria-valuemin="0"
                aria-valuemax="100">72%</div>
        </div>
        <div class="card-body">
            {{-- <form action="{{ route('kunjungan_usia_sekolah.store') }}" method="post" id="modal-save-form"> --}}
            <form action="{{ route('kunjungan_usia_sekolah.storeseko') }}" method="post" id="modal-save-form">
                @csrf
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('kk') is-invalid @enderror" name="kk"
                                    id="kk" placeholder="KK" value="{{ old('kk', $kk) }}" required readonly>
                                @error('kk')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    name="nama" id="nama" placeholder="Nama" value="{{ old('nama', $nama) }}"
                                    required>
                                @error('nama')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('tgl_timbang_ukur') }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('tmp_timbang_ukur') is-invalid @enderror"
                                    ...
                                    <option value="Sekolah" {{ old('tmp_timbang_ukur') == 'Sekolah' ? 'selected' : '' }}>
                                        Sekolah</option>
                                    <option value="Posyandu"
                                        {{ old('tmp_timbang_ukur') == 'Posyandu' ? 'selected' : '' }}>
                                        Posyandu</option>
                                    <option value="Rumah" {{ old('tmp_timbang_ukur') == 'Rumah' ? 'selected' : '' }}>
                                        Rumah</option>
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('porsi') is-invalid @enderror" name="porsi"
                                    ...
                                    <option value="Ya" {{ old('porsi') == 'Ya' ? 'selected' : '' }}>Ya
                                    </option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('bb_timbang_ukur') is-invalid @enderror"
                                    ...
                                    autocomplete="off" value="{{ old('bb_timbang_ukur') }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('tb_timbang_ukur') is-invalid @enderror"
                                    ...
                                    autocomplete="off" value="{{ old('tb_timbang_ukur') }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('lp_timbang_ukur') is-invalid @enderror"
                                    name="lp_timbang_ukur" id="lp_timbang_ukur" placeholder="LP" autocomplete="off"
                                    value="{{ old('lp_timbang_ukur') }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('ada_ttd_putri') is-invalid @enderror"
                                    ...
                                    <option value="Ya" {{ old('ada_ttd_putri') == 'Ya' ? 'selected' : '' }}>
                                        Ya</option>
                                    <option value="Tidak" {{ old('ada_ttd_putri') == 'Tidak' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                                @error('ada_ttd_putri')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('minum_ttd_putri') is-invalid @enderror"
                                    ...
                                    <option value="" disabled selected>Pilih Opsi</option>
                                    <option value="Ya" {{ old('minum_ttd_putri') == 'Ya' ? 'selected' : '' }}>
                                        Ya</option>
                                    <option value="Tidak" {{ old('minum_ttd_putri') == 'Tidak' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('tgl_skrining_hb_putri') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('tmp_skrining_hb_putri') is-invalid @enderror"
                                    ...
                                    <option value="Sekolah"
                                        {{ old('tmp_skrining_hb_putri') == 'Sekolah' ? 'selected' : '' }}>
                                        Sekolah</option>
                                    <option value="Posyandu"
                                        {{ old('tmp_skrining_hb_putri') == 'Posyandu' ? 'selected' : '' }}>
                                        Posyandu</option>
                                    <option value="Rumah"
                                        {{ old('tmp_skrining_hb_putri') == 'Rumah' ? 'selected' : '' }}>
                                        Rumah</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    ...
                                    autocomplete="off" value="{{ old('hasil_skrining_hb_putri') }}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('merokok') is-invalid @enderror" name="merokok"
                                    id="merokok" required>
                                    <option value="" disabled selected>Pilih Opsi</option>
                                    <option value="Aktif" {{ old('merokok') == 'Aktif' ? 'selected' : '' }}>
                                        Aktif</option>
                                    <option value="Pasif" {{ old('merokok') == 'Pasif' ? 'selected' : '' }}>
                                        Pasif</option>
                                </select>
                                @error('merokok')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="row" style="margin: 1%">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        autocomplete="off" value="{{ old('tgl_gula_darah_periksi_ptm') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select
                                        class="form-control @error('tmp_tekanan_darah_periksi_ptm') is-invalid @enderror"
                                        name="tmp_tekanan_darah_periksi_ptm" id="tmp_tekanan_darah_periksi_ptm" required>
                                        <option value="" disabled selected>Pilih Tempat</option>
                                        <option value="Sekolah"
                                            {{ old('tmp_tekanan_darah_periksi_ptm') == 'Sekolah' ? 'selected' : '' }}>
                                            Sekolah</option>
                                        <option value="Posyandu"
                                            {{ old('tmp_tekanan_darah_periksi_ptm') == 'Posyandu' ? 'selected' : '' }}>
                                            Posyandu</option>
                                        <option value="Rumah"
                                            {{ old('tmp_tekanan_darah_periksi_ptm') == 'Posyandu' ? 'selected' : '' }}>
                                            Posyandu</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('hasil_tekanan_darah_periksi_ptm') }}" required>
                        ...
                        <div class="row" style="margin: 1%">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        autocomplete="off" value="{{ old('tgl_tekanan_darah_periksi_ptm') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tmp_gula_darah_periksi_ptm') is-invalid @enderror"
                                        name="tmp_gula_darah_periksi_ptm" id="tmp_gula_darah_periksi_ptm" required>
                                        <option value="" disabled selected>Pilih Tempat</option>
                                        <option value="Sekolah"
                                            {{ old('tmp_gula_darah_periksi_ptm') == 'Sekolah' ? 'selected' : '' }}>
                                            Sekolah</option>
                                        <option value="Posyandu"
                                            {{ old('tmp_gula_darah_periksi_ptm') == 'Posyandu' ? 'selected' : '' }}>
                                            Posyandu</option>
                                        <option value="Rumah"
                                            {{ old('tmp_gula_darah_periksi_ptm') == 'Rumah' ? 'selected' : '' }}>
                                            Rumah</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        placeholder="Hasil" autocomplete="off"
                                        value="{{ old('hasil_gula_darah_periksi_ptm') }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tgl_skrining') is-invalid @enderror"
                                    ...
                                    value="{{ old('tgl_skrining') }}" required>
                                @error('tgl_skrining')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('tmp_skrining') is-invalid @enderror"
                                    ...
                                    <option value="" disabled selected>Pilih Tempat</option>
                                    <option value="Sekolah" {{ old('tmp_skrining') == 'Sekolah' ? 'selected' : '' }}>
                                        Sekolah</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    autocomplete="off" value="{{ old('petugas_skrining') }}" required>
                ...
                <div class="card" style="margin-top: 2%">
                    ...
                    {{-- <a href="{{ route('kunjungan_usia_sekolah.index') }}" class="btn btn-default">Kembali Ke List</a> --}}
                </div>
