...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('datakk.update', ['id' => $data->id]) }}" method="post" id="modal-save-form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('hubungan_keluarga') is-invalid @enderror"
                                ...
                                <option value="Pembantu/ Asisten/ Pekerja Lain"
                                    ...
                                    Pembantu/ Asisten/ Pekerja Lain</option>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('pendidikan_terakhir') is-invalid @enderror"
                                ...
                                <option value="s1_s2_s3"
                                    {{ old('pendidikan_terakhir') ?? $data->pendidikan_terakhir == 's1_s2_s3' ? 'selected' : '' }}>
                                    S1 / S2 /
                                    S3 (PT)</option>
                                <option value="d1_d2_d3"
                                    {{ old('pendidikan_terakhir') ?? $data->pendidikan_terakhir == 'd1_d2_d3' ? 'selected' : '' }}>
                                    D1 / D2 /
                                    D3</option>
                                <option value="sma"
                                    {{ old('pendidikan_terakhir') ?? $data->pendidikan_terakhir == 'sma' ? 'selected' : '' }}>
                                    SMA
                                    atau
                                    sederajat</option>
                                <option value="smp"
                                    {{ old('pendidikan_terakhir') ?? $data->pendidikan_terakhir == 'smp' ? 'selected' : '' }}>
                                    SMP
                                    atau
                                    sederajat</option>
                                <option value="sd"
                                    {{ old('pendidikan_terakhir') ?? $data->pendidikan_terakhir == 'sd' ? 'selected' : '' }}>
                                    SD atau
                                    sederajat
                                </option>
                                <option value="tidak_pernah_sekolah"
                                    {{ old('pendidikan_terakhir') ?? $data->pendidikan_terakhir == 'tidak_pernah_sekolah' ? 'selected' : '' }}>
                                    Tidak
                                    pernah
                                    sekolah</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('pekerjaan') is-invalid @enderror" name="pekerjaan"
                                ...
                                <option value="tidak_bekerja"
                                    {{ old('pekerjaan') ?? $data->pekerjaan == 'tidak_bekerja' ? 'selected' : '' }}>
                                    Tidak
                                    Bekerja</option>
                                <option value="pelajar_mahasiswa"
                                    {{ old('pekerjaan') ?? $data->pekerjaan == 'pelajar_mahasiswa' ? 'selected' : '' }}>
                                    Pelajar / Mahasiswa</option>
                                <option value="pns_tni_polri_bumn_bumd"
                                    {{ old('pekerjaan') ?? $data->pekerjaan == 'pns_tni_polri_bumn_bumd' ? 'selected' : '' }}>
                                    PNS / TNI-POLRI /
                                    BUMN /
                                    BUMD</option>
                                <option value="pegawai_swasta"
                                    {{ old('pekerjaan') ?? $data->pekerjaan == 'pegawai_swasta' ? 'selected' : '' }}>
                                ...
                                <option value="petani_nelayan"
                                    {{ old('pekerjaan') ?? $data->pekerjaan == 'petani_nelayan' ? 'selected' : '' }}>Petani
                                    / Nelayan</option>
                                <option value="lainnya"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('kelompok_sasaran') is-invalid @enderror"
                                ...
                                <option value="ibu_hamil"
                                    {{ old('kelompok_sasaran') ?? $data->kelompok_sasaran == 'ibu_hamil' ? 'selected' : '' }}>
                                    Ibu Hamil
                                </option>
                ...
                <a href="{{ route('datakk.index') }}" class="btn btn-default">Kembali Ke List</a>
