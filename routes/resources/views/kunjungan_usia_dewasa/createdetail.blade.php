...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            {{-- <form action="{{ route('kunjungan_usia_dewasa.store') }}" method="post" id="modal-save-form"> --}}
            <form action="{{ route('kunjungan_usia_dewasa.store2') }}" method="post" id="modal-save-form">
                @csrf
                ...
                <div class="card" style="margin-top: 2%">
                    ...
                    <div class="row" style="margin: 1%">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <h5>Terdiaknosa Darah Tinggi/ Hipertensi</h5>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
