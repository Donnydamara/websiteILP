...
@section('content')
    ...
    <div class="card">
        <div class="card-body" style="text-align: center;">
            <form action="{{ route('ibu_bersalin_nifas.storevalidate') }}" method="post" id="modal-save-form">
                @csrf
                ...
                <div class="card" style="margin-top: 2%">
                    ...
                    <a href="{{ route('ibu_bersalin_nifas.index') }}" class="btn btn-default">Kembali Ke List</a>
    ...
    <script>
        ...
        document.getElementById('btnCekData').addEventListener('click', function() {
            ...
            fetch('{{ route('ibu_bersalin_nifas.checkKK') }}', {
                    method: 'POST',
                    headers: {
